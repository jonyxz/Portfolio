...
export const EXPERIENCES = [
  {
    ...
    description: `Contributed to the development of the core ISO for TeaLinux, an open-source Linux distribution. Assisted in testing, debugging, and optimizing the system. Worked closely with the development team to ensure the stability and performance of the final release.`,
    technologies: ["Linux", "Shell Scripting", "Git", "ISO Building Tools"],
  },
  {
    year: "2022 - 2023",
    role: "Frontend Developer Intern",
    company: "Local Startup",
    description: `Supported the design and development of user interfaces for web applications using basic HTML, CSS, and JavaScript. Worked closely with the development team to integrate frontend components and optimize performance.`,
...
export const PROJECTS = [
  {
    ...
    technologies: ["HTML", "CSS", "Javascript", "PHP", "CI4"],
  },
  {
    title: "To-do List App",
    image: project2,
    description:
      "An application for managing tasks, with features such as task creation and assignment.",
    technologies: ["HTML", "CSS", "Javascript", "Bootstrap"],
  },
  {
...
export const CONTACT = {
  address: "Semarang Utara, Semarang, Jawa Tengah 50175",
  phoneNo: "+62 8953 2035 7269 ",
  email: "me@gmail.com",
};
